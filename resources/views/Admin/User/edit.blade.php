                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="tel" name="no_telp" id="no_telp" class="form-control" value="{{ $user->no_telp }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="role_name" id="role_name" class="form-control" required>
                                            ...
                                            <option value="pegawai" {{ $user->role_name === 'pegawai' ? 'selected' : '' }}>Pegawai</option>
                                            <option value="kasubagumum" {{ $user->role_name === 'kasubagumum' ? 'selected' : '' }}>Kasubagumum</option>
                                        </select>
                                    </div>
